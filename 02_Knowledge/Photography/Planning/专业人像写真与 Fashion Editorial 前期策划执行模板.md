---
title: 专业人像写真与 Fashion Editorial 前期策划执行模板
aliases:
  - 人像写真与 Fashion Editorial 前期策划模板
  - Editorial Portrait Pre-Production Template
tags:
  - photography
  - editorial
  - pre-production
...
```mermaid
flowchart LR
    A["Concept / Commission"] --> B["Creative Brief"]
    B --> C["Macro Moodboard"]
    C --> D["Lookbook / Styling Board"]
    C --> E["Beauty / Hair Board"]
    C --> F["Pose Board"]
    C --> G["Lighting Reference"]
    B --> H["Location Brief"]
    D --> I["Shot List"]
    E --> I
    F --> I
    G --> I
    H --> I
    I --> J["Call Sheet / Schedule"]
    I --> K["Budget / Estimate"]
    H --> L["Permit / Release Matrix"]
    B --> M["Usage / Delivery Spec"]
    J --> N["Shoot Day"]
    K --> N
    L --> N
    M --> O["Selects / Retouch / Delivery"]
    N --> O
```
